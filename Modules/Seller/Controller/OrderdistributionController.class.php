...
class OrderdistributionController extends CommonController{
    ...
    public function withdrawallist()
    {
        ...
        $sql = 'SELECT o.* FROM ' . C('DB_PREFIX') . "lionfish_comshop_orderdistribution_tixian_order o left join ".C('DB_PREFIX')."lionfish_comshop_orderdistribution co on o.member_id=co.member_id "
