		...
		if($order['is_pin'] == 0)
		{
			...
			if( $order_info['from_type'] == 'wepro' )
			{
				...
				if( $order_info['type'] == 'integral' )
				{
					...
					$order_info['total'] = $order_info['total']+$order_info['shipping_fare']-$order_info['voucher_credit']-$order_info['fullreduction_money'] - $order_info['fare_shipping_free'] + $order_info['localtown_free_shipping_fare'];
