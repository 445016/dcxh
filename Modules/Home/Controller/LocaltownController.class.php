...
class LocaltownController extends CommonController {
	...
	**/
    public function get_localtown_delivery()
    {
        ...
        $order_list = $redis->getRedis()->rawCommand('georadius', '_distributionorder', '106.611160', '29.647202', '10000', 'km', 'ASC');
	...
	**/
	public function distribution_arrived_order(  )
	{
		...
		$res = D('Home/LocaltownDelivery')->distribution_arrived_order( $order_id );
